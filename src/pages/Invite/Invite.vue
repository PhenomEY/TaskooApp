...
27 135 88 45 90 19 217 -57 267 -47 32 -125 32 -172 0z"/>
        ...
        <div class="invite-form-container" v-show="!inviteSuccess">
          ...
          <form novalidate class="form" @submit.prevent="finishInvite">
            ...
            <taskoo-input :error="inviteForm.password.error" type="password" :model="inviteForm.password.value" :placeholder="$t('login.labels.password')" :label="$t('login.labels.password')" @modelChanged="setPassword(...arguments)"></taskoo-input>
